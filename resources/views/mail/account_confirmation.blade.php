...
<head>
    ...
    <title>Movie Time Password Reset</title>
...
<body>
    <span class="preheader">Use this email to confirm your account. The email is only valid for 1 hour.</span>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>Hi {{ $user->name }}, We are excited to have you onboard, thanks for signing up to Movie Time.</p>
                                            <!-- Action -->
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; 2021 Movie Time. All rights
                                            reserved.</p>
                                    </td>
                                </tr>
                            </table>
